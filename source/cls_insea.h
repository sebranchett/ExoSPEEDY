...
C--IO s ocean mixed layer depth, sea-ice depth
C--IO s dissipation time for sea-surface and sea-ice temp. anomalies
C--IO s Heat flux coefficient at sea/ice interface
C--IO s Minimum fraction of sea for the definition of anomalies
C--IO s Geographical domain
