      SUBROUTINE RFFTI (N, WA, IFAC)
      DIMENSION WA(*), IFAC(*)
C***FIRST EXECUTABLE STATEMENT  RFFTI
      IF (N .EQ. 1) RETURN
      CALL RFFTI1 (N, WA, IFAC)
      RETURN
      END

      SUBROUTINE RFFTB (N, R, CH, WA, IFAC)
      DIMENSION R(*), CH(*), WA(*), IFAC(*)
C***FIRST EXECUTABLE STATEMENT  RFFTB
      IF (N .EQ. 1) RETURN
      CALL RFFTB1 (N,R,CH,WA,IFAC)
      RETURN
      END

      SUBROUTINE RFFTF (N, R, CH, WA, IFAC)
      DIMENSION R(*), CH(*), WA(*), IFAC(*)
C***FIRST EXECUTABLE STATEMENT  RFFTF
      IF (N .EQ. 1) RETURN
      CALL RFFTF1 (N,R,CH,WA,IFAC)
      RETURN
      END
